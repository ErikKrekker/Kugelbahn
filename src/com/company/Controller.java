...
public class Controller {
    ...
    static double detectionThreshold = 0.5;             //"Buffer" zur Abstandserkennung Kugel mit Linie
    ...
    public static void calcAcceleration(int ballID) {
        ...
        if(Screen.ball[ballID].isMagnet()) {
            double m1 = (Screen.lines[Screen.ball[ballID].getRollOn()].getY1() - Screen.lines[Screen.ball[ballID].getRollOn()].getY0()) / (Screen.lines[Screen.ball[ballID].getRollOn()].getX1() - Screen.lines[Screen.ball[ballID].getRollOn()].getX0());
            double F_reib = Math.abs(gravity[1] * Math.cos(Math.atan((m1)))) * 0.035;

            //if (Screen.ball[ballID].isMovable() && F > 32) {
            if (Screen.ball[ballID].isMovable() && F > F_reib) {
        ...
        }//&& !Screen.ball[ballID].isMagnet()
        // if (Screen.ball[ballID].isRollen())
        else if (Screen.ball[ballID].isRollen() && !Screen.ball[ballID].isMagnet()){
    ...
    public static void collisionCheckPointLine(int lineID, int ballID) {
        ...
        if (m == Double.NEGATIVE_INFINITY) {
            double temp = Screen.lines[lineID].getY0();
        ...
        else if (dotP > 0 && !Screen.ball[ballID].isRollen() && !Screen.ball[ballID].isCollision() && d <= detectionThreshold && hitbox(closest, ballID, m)) {
